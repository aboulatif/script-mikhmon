...
<div style="padding-top: 5%;"  class="login-box">
  <div class="card">
    <div class="card-header">
      <h3 class="align-middle text-center"><?= $_please_login ?></h3>
    </div>
    <div class="card-body">
      ...
      <table class="table" style="width:90%">
        ...
        <tr>
          <td class="align-middle text-center">
            <input style="width: 100%; height: 35px; font-size: 16px;" class="form-control" type="password" name="pass" placeholder="Mot de passe" required="1">
          </td>
        </tr>
        <tr>
          <td class="align-middle text-center">
